    ...
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <main>
        <section className="relative overflow-hidden">
          ...
          <div className="mx-auto max-w-6xl px-4 py-20 text-center sm:px-6 sm:py-28 lg:py-36">
            ...
            <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
              ...
              <Link
                href="/login"
                className="inline-flex items-center gap-2 rounded-xl border border-white/10 px-8 py-4 text-lg font-medium text-gray-300 transition-all hover:border-white/20 hover:bg-white/5"
              >
                Já tenho conta
              </Link>
            </div>
          ...
          <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6 sm:py-28">
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                <div
                  key={feature.title}
                  className="group rounded-2xl border border-white/5 bg-gray-900/80 p-6 transition-all hover:border-white/10 hover:bg-gray-900"
                >
                  <div
        ...
        <section className="border-t border-white/5">
          <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6 sm:py-28">
            <div className="rounded-2xl border border-white/5 bg-gradient-to-br from-indigo-600/20 via-gray-900 to-blue-600/20 p-8 text-center sm:p-16">
              <h2 className="text-3xl font-bold sm:text-4xl">
              ...
              <Link
                href="/register"
                className="mt-8 inline-flex items-center gap-2 rounded-xl bg-white px-8 py-4 text-lg font-semibold text-gray-900 transition-all hover:bg-gray-100 hover:scale-[1.02]"
              >
                Criar conta grátis
                <ArrowRight className="h-5 w-5" />
              </Link>
