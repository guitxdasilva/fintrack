...
export default function NotFound() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background px-4 text-foreground relative overflow-hidden">
      {/* Decorative shapes */}
      <div className="absolute top-1/3 -left-20 h-72 w-72 rounded-full bg-indigo-500/5 blur-3xl" />
      <div className="absolute bottom-1/3 -right-20 h-72 w-72 rounded-full bg-blue-500/5 blur-3xl" />
